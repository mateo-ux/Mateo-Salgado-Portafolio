...
export default function Hero() {
    ...
    return (
        <section style={{
            ...
            justifyContent: "center", padding: "8rem 4rem 4rem", position: "relative", overflow: "hidden"
        }}>
            {/* Glows */}
            <div style={{
        ...
        // Full Stack Developer · Manizales, Colombia
            ...
            <p style={{
                fontSize: "1.1rem", color: "var(--muted)", maxWidth: 500, marginTop: "2rem",
                animation: "fadeUp 0.8s 0.6s forwards", opacity: 0
            }}>
                Ingeniero Mecatrónico y en desarrollador Full Stack. Construyo aplicaciones web,
            ...
            <div style={{
                ...
                fontFamily: "var(--font-syne)", fontSize: "0.7rem", color: "var(--muted)",
