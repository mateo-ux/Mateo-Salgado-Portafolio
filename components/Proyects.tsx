...
const projects = [
    ...
    },
    {
        ...
        preview: null, // app móvil, no tiene URL web
        label: "App Móvil",
        icon: "📱",
    },
];
...
export default function Projects() {
    ...
    return (
        <section id="proyectos" ref={sectionRef} style={{ padding: "7rem 4rem", maxWidth: 1200, margin: "0 auto" }}>
                            ...
                            <div style={{
                                ...
                                {p.preview ? (
                                    <>
                                        ...
                                        />
                                        {/* Overlay para el degradado inferior */}
                                        <div style={{
        ...
        @media (max-width: 768px) {
          #proyectos > div:last-child { grid-template-columns: 1fr !important; }
        }
      `}</style>
        </section>
    );
