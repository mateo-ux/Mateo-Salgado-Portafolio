    ...
    <>
      ...
      <React.Fragment>
        <div id="contacto" ref={sectionRef} className="contact-section">
          ...
          <p className="reveal" style={{ color: "var(--muted)", maxWidth: 480, margin: "0 auto 2.5rem", lineHeight: 1.7 }}>
            Disponible para proyectos remotos en desarrollo web y móvil. Si tienes una idea o necesitas un desarrollador para tu equipo, escríbeme.
          </p>

          {/* Primary CTA — WhatsApp */}
          <div className="reveal" style={{ marginBottom: "1.5rem" }}>
            <a href={waUrl} target="_blank" rel="noopener noreferrer" className="contact-cta-primary">
          ...
          <div className="reveal" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.4rem", marginBottom: "2rem" }}>
            <a href="mailto:mateosalgado555@gmail.com" style={{
              fontFamily: "var(--font-syne)", fontSize: "0.78rem", color: "var(--muted)",
        ...
        <footer className="contact-footer">
          <p style={{ fontFamily: "var(--font-syne)", fontSize: "0.7rem", color: "var(--muted)" }}>
            © 2026 Mateo Alejandro Salgado Salgado
          </p>
          <p style={{ fontFamily: "var(--font-syne)", fontSize: "0.7rem", color: "var(--muted)" }}>
            Manizales, Colombia · Disponible para trabajo remoto
          </p>
        </footer>
