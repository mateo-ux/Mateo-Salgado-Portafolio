...
export default function Contact() {
  ...
  const handlePhoneEnter = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.currentTarget.style.borderColor = "var(--accent)";
    e.currentTarget.style.transform = "scale(1.1)";
  };

  const handlePhoneLeave = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.currentTarget.style.borderColor = "var(--border)";
    e.currentTarget.style.transform = "scale(1)";
  };

  const handleWaEnter = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.currentTarget.style.transform = "scale(1.1)";
    e.currentTarget.style.boxShadow = "0 8px 30px rgba(37,211,102,0.5)";
  };

  const handleWaLeave = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.currentTarget.style.transform = "scale(1)";
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="reveal" style={{ display: "flex", justifyContent: "center", gap: "1.2rem", flexWrap: "wrap" }}>
          {links.map((link) => (
            <a
              key={link.label}
              href={link.href}
